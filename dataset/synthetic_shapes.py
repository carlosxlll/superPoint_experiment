...
import sys
sys.path.append('/root/workspace/code/minesuperPoint_experiment')
...
if __name__=="__main__":
    ...
    config_file = '/root/workspace/code/mine/superPoint_experiment/config/magic_point_syn_train.yaml'
