...
if __name__=='__main__':
    ...
    experiments = ['./data/hpatches_val/EX2.superpoint_bn_index_coco_loss4/repeatibility/hpatches/v', 
                   './data/hpatches_val/EX2.superpoint_bn_index_coco_loss4/repeatibility/hpatches/i', 
                   './data/hpatches_val/EX2.superpoint_bn_index_coco_loss4/repeatibility/hpatches/all']
    experiments_picture = ['./data/hpatches_val/EX2.superpoint_bn_index_coco_loss4/repeatibility/hpatches/v/picture',
                           './data/hpatches_val/EX2.superpoint_bn_index_coco_loss4/repeatibility/hpatches/i/picture',
                           './data/hpatches_val/EX2.superpoint_bn_index_coco_loss4/repeatibility/hpatches/all/picture']
    # 遍历列表，创建每个文件夹
    for path in experiments_picture:
        os.makedirs(path, exist_ok=True)
    confidence_thresholds = [0.015, 0.015, 0.015]
